...
<body class="min-h-screen font-sans antialiased">
    ...
    <div class="relative flex min-h-screen">
        <aside class="hidden w-64 shrink-0 flex-col bg-plum px-5 py-6 text-white lg:flex">
            ...
            <div class="mt-auto rounded-2xl border border-white/10 bg-white/5 p-4"><p class="text-xs font-semibold text-violet">Your workspace</p><p class="mt-2 text-xs leading-5 text-[#cdbfe0]">The clearest next step is usually the best one.</p></div>
        </aside>
        <div class="relative min-w-0 flex-1">
            <div class="mx-auto max-w-[1440px] px-4 py-4 sm:px-8 lg:px-12 lg:py-6">
                <header class="flex items-center rounded-2xl border border-white/70 bg-white/70 px-4 py-3 shadow-sm backdrop-blur sm:px-5 lg:hidden"><a href="{{ route('tasks.index') }}" class="flex items-center gap-3" aria-label="xans task manager home"><span class="flex h-9 w-9 items-center justify-center rounded-xl bg-plum text-violet"><svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M12 5v14"/></svg></span><span><span class="block text-sm font-bold tracking-tight text-ink">xans task manager</span><span class="block text-[9px] font-semibold uppercase tracking-[.2em] text-muted">Personal workspace</span></span></a></header>
